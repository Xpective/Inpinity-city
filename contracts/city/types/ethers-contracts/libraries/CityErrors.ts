...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener } from "../common.js"
  ...
  export interface CityErrorsInterface extends Interface {
  ...
  export interface CityErrors extends BaseContract {
    
    connect(runner?: ContractRunner | null): CityErrors;
    waitForDeployment(): Promise<this>;

    interface: CityErrorsInterface;
